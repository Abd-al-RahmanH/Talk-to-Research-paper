    ...
    if st.button("Search") and user_question:      
        ...
        with st.spinner("Vectorizing results"):
            ...
            if titles is not None:     
                ...
                combined_string = ', <br> '.join(enumerated_strings)  # Separate each enumerated string by a new line
                st.write(bot_template.replace("{{MSG}}",  "ON DATABASE I FOUND THE RELEVATENT PAPERS FOR YOUR QUERY-->: " +combined_string), unsafe_allow_html=True)
